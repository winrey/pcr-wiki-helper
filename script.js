...
不含反引号 输出后模仿格式(注意前后引号!!)复制到下面maps中
    */
        ...
        const maps = ["朱諾平原N","帕拉斯高原N","赫柏丘陵N","維斯塔溪谷N","刻瑞斯森林N","佛洛拉湖畔N","墨提斯大瀑布N","伊麗絲樹海N","弗麗嘉雪原N",
                      "洛麗泰海岸N","蓋奴亞荒漠N","波諾尼亞砂丘N","朵羅西亞溼地N","尤金尼亞熱地N","塔利亞火山N","泰美斯銀嶺N","菲得斯冰原N","法艾頓草原N",
                      "法艾頓草原‧南部N","卡斯塔利亞樹林‧西部N","卡斯塔利亞樹林‧東部N","馬提爾德岩峰‧南部N","馬提爾德岩峰‧北部N","雷蒂烏斯群峰‧西麓N",
                      "雷蒂烏斯群峰‧東麓N","佩特羅大森林‧西部N","佩特羅大森林‧東部N","迪茲塔爾河蝕岸‧北部N","迪茲塔爾河蝕岸‧南部N","弗泰拉斷崖‧北部N",
                      "弗泰拉斷崖‧南部N","法斯奇亞森林‧南部N","法斯奇亞森林‧東部N","迪克斯提亞岩崖‧西壁N","迪克斯提亞岩崖‧東壁N","維娜湖畔道‧南部N",
                      "維娜湖畔道‧北部N","拉圖斯斷崖‧南部N","拉圖斯斷崖‧北部N","スカプ山系・西麓N","スカプ山系・東麓N","ペクトス氷峰・西壁N","ペクトス氷峰・東壁N"]
        let i = 1
        for (let m of maps) {
